...
class SuidexAPIOrderBookDataSourceTests(TestCase):
    ...
    def test_listen_for_order_book_diffs_logs_exception(self):
        ...
        self.assertTrue(
            self.is_logged("ERROR", "Unexpected error when processing public order book updates from exchange")
        )

    @patch("hummingbot.connector.exchange.suidex.suidex_data_source.SuidexDataSource._time")
