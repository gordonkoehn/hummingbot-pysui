...
class SuidexQueryExecutorTests(TestCase):
    def setUp(self) -> None:
        super().setUp()
    ...
    @patch("hummingbot.connector.exchange.suidex.suidex_query_executor.AppSyncWebsocketsTransport")
    @patch("hummingbot.connector.exchange.suidex.suidex_query_executor.Client")
