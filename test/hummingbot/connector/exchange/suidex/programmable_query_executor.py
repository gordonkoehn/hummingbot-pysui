...
# from hummingbot.connector.exchange.suidex.suidex_query_executor import BaseQueryExecutor


# TODO: rename to MockableQueryExecutor
# class MockableQueryExecutor(BaseQueryExecutor):
class ProgrammableQueryExecutor:
    def __init__(self):
    ...
    async def place_order(self, suidex_order: Dict[str, Any], signature: Dict[str, Any]) -> Dict[str, Any]:
